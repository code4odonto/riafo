<?php $riafoTitle = 'Riafo: Registro informatizado de alumnos';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <div class="login-wrapper">
        <?= $this->Form->create() ?> 
            <div class="data-input">
                ...
                <p class= "help-info"><?= $this->Html->link("Olvidé mi contraseña &raquo;", ['action' => 'forgotPassword'], ['escape' => false])?></p>
                <div>
                <?= $this->Flash->render(); ?>
                </div>
            </div>
            ...
            <div id="login">
                <button type="submit" id="logBtn"><span id="btnCont">&raquo;</span></button>
            </div>
        </form>
        <?= $this->Form->end() ?>
    </div>
